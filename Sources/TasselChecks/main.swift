...
Expect.suite("tassel:// urls parse") {
    ...
    Expect.that(command("tassel://charm?name=Maneki%20Neko") == .charm("Maneki Neko"), "an escaped space should decode")
    Expect.that(command("tassel://charm?other=x&name=Bell") == .charm("Bell"), "name should be found among other parameters")
